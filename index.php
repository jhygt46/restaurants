...
if(isset($info['id_gir'])){
    ...
    if(isset($_GET["css_color"])){
        $info["css_color"] = "css_colores_".$_GET["css_color"].".css";
    }
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <div class="pagina">
                <div class="cont_pagina">
                    <div class="header <?php echo ($info["header_fixed"] == 1) ? 'fixed' : ''; ?>">
                        <div class="header_logo vhalign"><img src="<?php echo $info["path"]; ?>/images/logos/<?php echo $info["logo"]; ?>" alt="" /></div>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $info['mapcode']; ?>" async defer></script>
    </body>
</html>
