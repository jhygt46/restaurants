            ...
            <ul class='listUser'>
                ...
                <li class="user">
                    <ul class="clearfix">
                        ...
                        <a title="Ver Catalogo" class="icn catalogo" onclick="navlink('pages/apps/ver_catalogo.php?id_cat=<?php echo $id_n; ?>&nombre=<?php echo $nombre; ?>&id_app=<?php echo $_GET['id_app']; ?>')"></a>
                    </ul>
                </li>
