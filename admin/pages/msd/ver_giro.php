        ...
        <div class="cont_pag">
            <div class="lista_items">
                ...
                <div class="items_list clearfix">
                    ...
                    <?php if($giro["dns"] == 0 && $giro["dns_letra"] != 0){ ?><div class="list_item wi_02"><div class="dns_item"><div class="cont_dns"><?php for($i=1; $i<=4; $i++){ ?><h1>ns-cloud-<?php echo $giro["dns_letra"].$i; ?>.googledomains.com</h1><?php } ?></div></div><div class="dns_info">CAMBIA TUS DNS</div></div><?php } ?>
