                ...
                <div class="listado_items">
                    ...
                    <div class="l_item">
                        <div class="detalle_item clearfix">
                            <div class="nombre"><?php if($dns_letra === NULL){ echo "<p style='font-weight: bold; color: #900; font-size: 17px'>Falta crear zona DNS para ".$dominio."</p>"; }else{ echo $nombre; } ?></div>
