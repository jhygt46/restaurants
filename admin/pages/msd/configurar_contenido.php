    ...
    <div class="cont_pagina">
        <div class="cont_pag">
            <div class="lista_items">
                <div class="titulo_items"><h1>Contenido</h1><h2>Agrega contenido a tu sitio</h2></div>
                <div class="items_list clearfix">
                    ...
                    <!--<div class="list_item wi_01"><div class="cont_item" onclick="navlink('pages/msd/ingredientes.php')"><div class="item_image"><img src="images/menuingredientes.png" alt="" /></div><div class="item_ttl">LISTA<br>INGREDIENTES</div></div></div>-->
                </div>
            </div>
        </div>
    </div>
