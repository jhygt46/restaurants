...
<div class="pagina">
    ...
    <div class="cont_pagina">
        <div class="cont_pag">
            ...
            <div id="container_01" style="height: 150px; display: block"></div>
            <div id="container_02" style="margin-top: 10px; height: 150px; display: block"></div>
            <div id="container_03" style="margin-top: 10px; height: 150px; display: block"></div>
        </div>
    </div>
</div>