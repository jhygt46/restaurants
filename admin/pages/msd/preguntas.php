            ...
            <div class="listado_items">
                ...
                <div class="l_item">
                    <div class="detalle_item clearfix">
                        ...
                        <a class="icono ic11" onclick="eliminar('<?php echo $eliminaraccion; ?>', '<?php echo $_GET['id_cat']; ?>/<?php echo $id; ?>', '<?php echo $eliminarobjeto; ?>', '<?php echo $nombre; ?>')"></a>
