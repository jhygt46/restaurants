...
class Rest{
    ...
    public function enviar_pedido(){
        ...
        if($nombre != "" && $telefono != "+569 "){
            ...
            $pedido_sql = $this->con->sql("INSERT INTO pedidos_aux (code, fecha, id_loc, tipo, carro, promos, verify_despacho) VALUES ('".$pedido_code."', now(), '".$id_loc."', '1', '".$_POST['carro']."', '".$_POST['promos']."', '".$verify_despacho."')");
