        ...
        <div class="contenedor">
            ...
            <div class="contenido">
                <div class="pedidos">
                    ...
                    <div class="config_pedido"><div class="cont_config"><div class="icons vhalign"><div class="ic icon1 material-icons">my_location</div><div class="ic icon2 material-icons">my_location</div><div class="ic icon3 material-icons">my_location</div></div></div></div>
                </div>
                ...
                <div class="configuracion">
                    <div class="ic icon1 material-icons">my_location</div>
                    <div class="ic icon2 material-icons">my_location</div>
                    <div class="ic icon3 material-icons">my_location</div>
                </div>
            </div>
