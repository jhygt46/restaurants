...
$tablas[1]['campos'][57]['tipo'] = 'int(4)';
$tablas[1]['campos'][57]['null'] = 0;
$tablas[1]['campos'][58]['nombre'] = 'monto_vendedor';
$tablas[1]['campos'][58]['tipo'] = 'int(4)';
$tablas[1]['campos'][58]['null'] = 0;
$tablas[1]['campos'][59]['nombre'] = 'cant_pagos';
$tablas[1]['campos'][59]['tipo'] = 'smallint(2)';
$tablas[1]['campos'][59]['null'] = 0;
$tablas[1]['campos'][60]['nombre'] = 'prueba';
$tablas[1]['campos'][60]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][60]['null'] = 0;
$tablas[1]['campos'][61]['nombre'] = 'id_ser';
$tablas[1]['campos'][61]['tipo'] = 'int(4)';
$tablas[1]['campos'][61]['null'] = 0;
$tablas[1]['campos'][61]['k'] = 1;
$tablas[1]['campos'][61]['kt'] = 0;
$tablas[1]['campos'][61]['kc'] = 0;
$tablas[1]['campos'][62]['nombre'] = 'eliminado';
...
$tablas[7]['campos'][16]['nombre'] = 'telefono';
$tablas[7]['campos'][16]['tipo'] = 'varchar(15) COLLATE utf8_spanish2_ci';
$tablas[7]['campos'][16]['null'] = 0;
$tablas[7]['campos'][16]['values'] = ["+56966166923"];
$tablas[7]['campos'][17]['nombre'] = 'id_loc';
$tablas[7]['campos'][17]['tipo'] = 'int(4)';
$tablas[7]['campos'][17]['null'] = 0;
$tablas[7]['campos'][17]['values'] = ["0"];
$tablas[7]['campos'][18]['nombre'] = 'id_gir';
$tablas[7]['campos'][18]['tipo'] = 'int(4)';
$tablas[7]['campos'][18]['null'] = 0;
$tablas[7]['campos'][18]['values'] = ["1"];
$tablas[7]['campos'][19]['nombre'] = 'eliminado';
$tablas[7]['campos'][19]['tipo'] = 'tinyint(1)';
$tablas[7]['campos'][19]['null'] = 0;
$tablas[7]['campos'][19]['values'] = ["0"];
