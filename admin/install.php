...
$tablas[1]['campos'][42]['nombre'] = 'pedido_palitos';
$tablas[1]['campos'][42]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][42]['null'] = 0;
$tablas[1]['campos'][43]['nombre'] = 'pedido_comentarios';
$tablas[1]['campos'][43]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][43]['null'] = 0;
$tablas[1]['campos'][44]['nombre'] = 'pedido_soya';
$tablas[1]['campos'][44]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][44]['null'] = 0;
$tablas[1]['campos'][45]['nombre'] = 'pedido_teriyaki';
$tablas[1]['campos'][45]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][45]['null'] = 0;
$tablas[1]['campos'][46]['nombre'] = 'desde';
$tablas[1]['campos'][46]['tipo'] = 'int(4)';
$tablas[1]['campos'][46]['null'] = 0;
$tablas[1]['campos'][47]['nombre'] = 'mapcode';
$tablas[1]['campos'][47]['tipo'] = 'varchar(100) COLLATE utf8_spanish2_ci';
$tablas[1]['campos'][47]['null'] = 0;
$tablas[1]['campos'][48]['nombre'] = 'item_grafico';
$tablas[1]['campos'][48]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][48]['null'] = 0;
$tablas[1]['campos'][49]['nombre'] = 'item_pos';
$tablas[1]['campos'][49]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][49]['null'] = 0;
$tablas[1]['campos'][50]['nombre'] = 'item_cocina';
$tablas[1]['campos'][50]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][50]['null'] = 0;
$tablas[1]['campos'][51]['nombre'] = 'item_pagina';
$tablas[1]['campos'][51]['tipo'] = 'tinyint(1)';
$tablas[1]['campos'][51]['null'] = 0;
$tablas[1]['campos'][52]['nombre'] = 'fecha_creado';
$tablas[1]['campos'][52]['tipo'] = 'datetime';
$tablas[1]['campos'][52]['null'] = 0;
$tablas[1]['campos'][53]['nombre'] = 'tiempo_aviso';
$tablas[1]['campos'][53]['tipo'] = 'smallint(2)';
