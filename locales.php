                    ...
                    <div class="p1 nuevo_pedido vhalign" style="display: none">
                        ...
                        <div class="n_info">
                            <div class="data_info">
                                ...
                                <div class="preguntas">
                                    <div class="pregunta clearfix" style="padding-bottom: 10px">
                                        <div class="pre_nom" style="width: 70%">Repartidor</div>
                                        <div class="pre_check" style="width: 30%"><select><option value="0">Seleccionar</option><option value="1">Juan</option><option value="1">Maximiliano</option></select></div>
                                    </div>
                                ...
                                <div class="preguntas">
                                    <div class="pregunta clearfix">
                                        <div class="btn_pedido"><div style="background: #f00" class="btn_ped"><p class="vhalign">Boton 1</p></div></div>
                                        <div class="btn_pedido"><div style="background: #0f0" class="btn_ped"><p class="vhalign">Boton 2</p></div></div>
                                        <div class="btn_pedido"><div style="background: #00f" class="btn_ped"><p class="vhalign">Boton 3</p></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
