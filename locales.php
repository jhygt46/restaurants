                            ...
                            <div class="data_info">
                                ...
                                <div class="preguntas">
                                    <div class="pregunta t_repartidor clearfix" style="padding-bottom: 10px">
                                        ...
                                        <div class="pre_check" style="width: 30%"><select id="mot"><option value="0">Seleccionar</option><option value="1">Juan</option><option value="1">Maximiliano</option></select></div>
                                    </div>
